...
![](https://cdn-images-1.medium.com/max/800/1*I7b7KbTMuZpzqWUV-7PxVw.png)

Run the lint check in Android Studio:

![](https://cdn-images-1.medium.com/max/800/1*nH5v18_s6RM3bAQRY6nQ6g.png)

Voila!

![](https://cdn-images-1.medium.com/max/800/1*JoIXpT9kHglyml5758o96A.png)

#### Editing rules

Alter this rule to check for `hello` .

![](https://cdn-images-1.medium.com/max/800/1*bjReVwhFQMVx7Mc0iK0YdQ.png)
...
![](https://cdn-images-1.medium.com/max/800/1*JuOqDnQ6QfEjOI3O73lMuw.png)

Let’s have a look what is this even and why would it complain:

![](https://cdn-images-1.medium.com/max/800/1*KNUfxnaBmcmpLd_EOxqQDA.png)
...
![](https://cdn-images-1.medium.com/max/800/1*MPVwr-zakwRFLKjNF1B_TA.png)
